...
export default function Properties() {
	...
	const [formData, setFormData] = useState<FProperties>({
		semStartDate: "",
		semEndDate: "",
		inMaintenance: false,
		isAvailable: false,
	...
	useEffect(() => {
		if (
			adminData &&
			adminData.inMaintenance != null &&
			adminData.semStartDate != null &&
			adminData.semEndDate != null
		) {
			setFormData({
				...
				>
					<LocalizationProvider dateAdapter={AdapterDayjs}>
						<DatePicker
							...
							value={
								formData.semStartDate
									? dayjs(formData.semStartDate)
									: dayjs()
							}
							onChange={(newValue) =>
								setFormData({
									...formData,
									semStartDate: newValue
