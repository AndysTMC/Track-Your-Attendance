...
export default function Holidays() {
	...
	const [holidaysDetails, setHolidaysDetails] = useState<FHoliday[] | null>(
		null
	);
	...
	const handleRemoveHoliday = (holidayIndex: number) => {
		if (holidaysDetails) {
			dispatch(
				addOrRemoveHoliday({
					add: false,
					date: holidaysDetails[holidayIndex].date.format(
						"YYYY-MM-DD"
					),
				...
				>
					...
					>
						<LocalizationProvider dateAdapter={AdapterDayjs}>
							<DateCalendar
								value={
									selectedCalDate ? selectedCalDate : dayjs()
								}
								disabled={true}
								className={`
                                        w-full md:w-max
								...
								return (
									...
									>
										<div
                                            ...
                                            `}
											onClick={() =>
												setSelectedCalDate(holiday.date)
											}
										>
											<div
												className={`
