...
export default function ScheduleSCard({
    sessionNo, courseName, durationString, room, faculty, courseCode, ltpc
}: { sessionNo: number, courseName: string, durationString: string, room: string, faculty: string, courseCode: string, ltpc: string }) {
    return (
        <div className={`
            w-auto h-auto
            rounded-xl
