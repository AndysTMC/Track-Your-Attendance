    ...
    return (
        ...
        >
            ...
            >
                ...
                <CopyPaste data={getPrettierCoursesOverview(userData!.courses)} />
            </div>
            <div className={`
            w-full h-auto
            bg-white
                            ...
                            return (
                                <React.Fragment key={index}>
                                    ...
                                    `}>
                                            ...
                                            <div className='text-xs text-pretty font-bold'>{course.code}</div>
                                        </div>
                                        <div className={`
                                            col-span-10 sm:col-span-7 bsm:col-span-4 md:col-span-3
                                    `}>
                                            <div className='text-ssm'>Name</div>
                                            <div className='text-xs text-pretty font-bold'>{course.name}</div>
                                        </div>
                                        <div className={`
                                            col-span-10 sm:col-span-10 bsm:col-span-4 md:col-span-2
                                    `}>
                                            <div className='text-ssm'>Faculty</div>
                                            <div className='text-xs text-balance font-bold'>{course.faculty}</div>
                                        </div>
                                        <div className={`
                                            col-span-10 sm:col-span-2 md:col-span-1
                                    `}>
                                            <div className='text-ssm'>Lectures</div>
                                            <div className='text-xs text-pretty font-bold'>{course.ltpc.split('-')[0]}</div>
                                        </div>
                                        <div className={`
                                            col-span-10 sm:col-span-2 md:col-span-1
                                    `}>
                                            <div className='text-ssm'>Tutorials</div>
                                            <div className='text-xs text-pretty font-bold'>{course.ltpc.split('-')[1]}</div>
                                        </div>
                                        <div className={`
                                            col-span-10 sm:col-span-2 md:col-span-1
                                    `}>
                                            <div className='text-ssm'>Practicals</div>
                                            <div className='text-xs text-pretty font-bold'>{course.ltpc.split('-')[2]}</div>
                                        </div>
                                        <div className={`
                                            col-span-10 sm:col-span-2 md:col-span-1
                                    `}>
                                            <div className='text-ssm'>Credits</div>
                                            <div className='text-xs text-pretty font-bold'>{course.ltpc.split('-')[3]}</div>
                                        </div>
                                    </div>
                                </React.Fragment>
                            )
