...
import { generateAdminKey } from '../utils/backend';
...
const UserSchema = new Schema({
    ...
    scrapeInProgress: { type: Boolean, required: true },
}, { versionKey: false });
...
const SystemStateSchema = new Schema({
    invalidAuths: { type: Map, of: String, default: {} },
...
const SystemStateModel = mongoose.models?.SystemState || mongoose.model('SystemState', SystemStateSchema, 'systemState');
const UserModel = mongoose.models?.User || mongoose.model('User', UserSchema, 'users');
const HolidayModel = mongoose.models?.Holiday || mongoose.model('Holiday', HolidaySchema, 'holidays');
const SpecialWorkingDayModel = mongoose.models?.SpecialWorkingDay || mongoose.model('SpecialWorkingDay', SpecialWorkingDaySchema, 'specialWorkingDays');
